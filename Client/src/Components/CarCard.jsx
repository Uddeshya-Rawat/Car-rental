...
const CarCard = ({ car }) => {
    ...
    return (
        ...
        <div className='group rounded-xl overflow-hidden shadow-lg hover:translate-y-1 tarnstion-all duration-500 cursor-pointer'>
            <div className='relative h-48 overflow-hidden'>
                <img src={car.image} alt='car image' className='w-full h-full object-cover transition-tranform duration-500 group-hover:scale-105' />
